...
<head>
    ...
    <title>Quản lý ngữ pháp | HànNgữ Admin</title>
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <div class="admin-header">
            <h1>Ngữ pháp</h1>
            <a href="admin_mvc.php?action=grammar_create" class="btn btn--primary">+ Thêm ngữ pháp</a>
        </div>

        <div class="admin-card">
            <div class="filters">
                <form method="GET">
                    <input type="hidden" name="action" value="grammar">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                <a href="admin_mvc.php?action=grammar_edit&id=<?= (int)$g['id'] ?>" class="btn btn--small btn--primary">Sửa</a>
                                <a href="admin_mvc.php?action=grammar_delete&id=<?= (int)$g['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Xóa ngữ pháp này?')">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=grammar&page=<?= $p ?>&lesson_id=<?= $lessonId ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
