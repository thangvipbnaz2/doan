...
<head>
    ...
    <title><?= isset($lesson) && $lesson ? 'Chỉnh sửa bài học' : 'Thêm bài học' ?> | HànNgữ Admin</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @media(max-width:640px){.admin-sidebar{display:none}.admin-content{margin-left:0}.form-card{padding:20px}}
    </style>
</head>
<body>
<div class="admin-layout">
    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <a href="admin_mvc.php?action=lessons" class="btn btn--outline">← Quay lại</a>
        </div>

        <div class="form-card">
            <form method="POST" action="admin_mvc.php?action=<?= isset($lesson) && $lesson ? 'lesson_update&id=' . (int)$lesson['id'] : 'lesson_save' ?>">
                <div class="fg">
                ...
                <div style="display:flex;gap:12px;margin-top:24px">
                    ...
                    <a href="admin_mvc.php?action=lessons" class="btn btn--outline">Hủy</a>
                </div>
            </form>
        </div>
    </main>
