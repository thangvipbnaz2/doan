...
<head>
    ...
    <title>Quản lý đơn hàng | HànNgữ Admin</title>
...
<div class="admin-layout">
    <nav class="admin-sidebar">
        ...
        <a href="admin_mvc.php?action=orders" class="admin-nav-item admin-nav-item--active"><span class="icon">🛒</span> Đơn hàng</a>
    ...
    <main class="admin-content">
        ...
        <div class="admin-card">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                ...
                                <a href="admin_mvc.php?action=order_confirm&id=<?= (int)$o['id'] ?>" class="btn btn--small btn--success">Xác nhận</a>
                                <a href="admin_mvc.php?action=order_cancel&id=<?= (int)$o['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Hủy đơn hàng #<?= (int)$o['id'] ?>?')">Hủy</a>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=orders&page=<?= $p ?>&status=<?= escape($status) ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
