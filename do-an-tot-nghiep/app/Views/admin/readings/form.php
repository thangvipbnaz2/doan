...
<head>
    ...
    <title><?= isset($reading) && $reading ? 'Chỉnh sửa bài đọc' : 'Thêm bài đọc' ?> | HànNgữ Admin</title>
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <a href="admin_mvc.php?action=readings" class="btn btn--outline">← Quay lại</a>
        </div>

        <div class="form-card">
            <form method="POST" action="admin_mvc.php?action=<?= isset($reading) && $reading ? 'reading_update&id=' . (int)$reading['id'] : 'reading_save' ?>">
                <div class="fg">
                    <label>Bài học</label>
                ...
                <div style="display:flex;gap:12px;margin-top:24px">
                    ...
                    <a href="admin_mvc.php?action=readings" class="btn btn--outline">Hủy</a>
                </div>
            </form>
        </div>
    </main>
