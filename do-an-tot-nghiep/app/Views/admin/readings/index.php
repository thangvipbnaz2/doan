...
<head>
    ...
    <title>Quản lý bài đọc | HànNgữ Admin</title>
...
<div class="admin-layout">
    <nav class="admin-sidebar">
        ...
        <a href="admin_mvc.php?action=readings" class="admin-nav-item admin-nav-item--active"><span class="icon">📖</span> Đọc</a>
    ...
    <main class="admin-content">
        <div class="admin-header">
            <h1>Bài đọc</h1>
            <a href="admin_mvc.php?action=reading_create" class="btn btn--primary">+ Thêm bài đọc</a>
        </div>
        ...
        <div class="admin-card">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                <a href="admin_mvc.php?action=reading_edit&id=<?= (int)$r['id'] ?>" class="btn btn--small btn--primary">Sửa</a>
                                <a href="admin_mvc.php?action=reading_delete&id=<?= (int)$r['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Xóa bài đọc này?')">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=readings&page=<?= $p ?>&lesson_id=<?= $lessonId ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
