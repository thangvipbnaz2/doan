...
<head>
    ...
    <title>Quản lý bài nói | HànNgữ Admin</title>
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <div class="admin-header">
            <h1>Bài nói</h1>
            <a href="admin_mvc.php?action=speaking_create" class="btn btn--primary">+ Thêm bài nói</a>
        </div>

        <div class="admin-card">
            <div class="card-header">
                <form method="GET" class="filters">
                    <input type="hidden" name="action" value="speaking">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                <a href="admin_mvc.php?action=speaking_edit&id=<?= (int)$s['id'] ?>" class="btn btn--small btn--primary">Sửa</a>
                                <a href="admin_mvc.php?action=speaking_delete&id=<?= (int)$s['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Xóa bài nói này?')">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=speaking&page=<?= $p ?>&lesson_id=<?= $lessonId ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
