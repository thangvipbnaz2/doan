...
<head>
    ...
    <title>Quản lý từ vựng | HànNgữ Admin</title>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        :root{--teal:#0d9488;--teal-dark:#0f766e;--teal-light:#ccfbf1;--coral:#f97316;--dark:#0f172a;--dark-2:#1e293b;--dark-3:#334155;--gray:#64748b;--gray-light:#e2e8f0;--bg:#fafbfc;--radius:16px;--radius-sm:10px;--shadow:0 4px 24px rgba(0,0,0,0.05);--transition:all .3s cubic-bezier(.4,0,.2,1);--font-sans:'Inter',sans-serif;--font-hanzi:'Noto Sans SC',sans-serif}
        body{font-family:var(--font-sans);background:var(--bg);color:var(--dark);font-size:.92rem}
        ...
        .btn--outline{border:2px solid var(--gray-light);color:var(--dark-3);background:#fff}
        ...
        .card-header{padding:20px 24px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;border-bottom:1px solid var(--gray-light)}
        ...
        .td-hanzi{font-family:var(--font-hanzi);font-size:1.3rem;font-weight:700}
    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <div style="display:flex;gap:8px">
                <a href="admin_mvc.php?action=vocab_create" class="btn btn--primary">+ Thêm từ vựng</a>
            </div>
        </div>
        ...
        <div class="admin-card">
            <div class="card-header">
                <form method="GET" class="filters">
                    <input type="hidden" name="action" value="vocab">
                    <select name="level">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                <a href="admin_mvc.php?action=vocab_edit&id=<?= (int)$v['id'] ?>" class="btn btn--small btn--primary">Sửa</a>
                                <a href="admin_mvc.php?action=vocab_delete&id=<?= (int)$v['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Xóa từ <?= escape($v['hanzi']) ?>?')">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=vocab&page=<?= $p ?>&level=<?= escape($level) ?>&lesson_id=<?= $lessonId ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
