...
<head>
    ...
    <title>Quản lý bài viết | HànNgữ Admin</title>
...
<div class="admin-layout">
    ...
    <main class="admin-content">
        <div class="admin-header">
            ...
            <a href="admin_mvc.php?action=writing_create" class="btn btn--primary">+ Thêm bài viết</a>
        </div>

        <div class="admin-card">
            <div class="card-header">
                <form method="GET" class="filters">
                    <input type="hidden" name="action" value="writing">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:4px">
                                <a href="admin_mvc.php?action=writing_edit&id=<?= (int)$w['id'] ?>" class="btn btn--small btn--primary">Sửa</a>
                                <a href="admin_mvc.php?action=writing_delete&id=<?= (int)$w['id'] ?>" class="btn btn--small btn--danger" onclick="return confirm('Xóa bài viết này?')">Xóa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <div class="pagination">
                ...
                <a href="admin_mvc.php?action=writing&page=<?= $p ?>&lesson_id=<?= $lessonId ?>" class="page-link <?= $p === $page ? 'active' : '' ?>"><?= $p ?></a>
                <?php endfor; ?>
            </div>
            <?php endif; ?>
        </div>
