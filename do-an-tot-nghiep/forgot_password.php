...
<body>
    ...
    <main class="auth-page">
        <div class="auth-card">
            ...
            <p class="auth-card__desc">Nhập email đã đăng ký để nhận link đặt lại mật khẩu.</p>
            ...
            <form id="forgot-form">
                ...
                <button type="submit" class="btn btn--primary btn--block ripple" id="btn-submit">Gửi yêu cầu</button>
            </form>
