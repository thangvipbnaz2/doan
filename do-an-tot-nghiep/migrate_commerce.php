...
session_start(); require 'db.php'; require 'commerce.php';
...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    $seed = [
        ...
        ['hsk-6-chuyen-sau','HSK 6 - Chuyên sâu',4290000,'Lộ trình chinh phục HSK 6 dành cho người học trình độ cao.',6],
    ];
