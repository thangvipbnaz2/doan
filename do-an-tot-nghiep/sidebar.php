...
<nav class="sidebar" id="sidebar">
    <ul class="sidebar__menu">
        <li><a href="index.php" class="sidebar__link<?= sidebarActive('index.php', $current_page) ?>"> Trang chủ</a></li>
        <li><a href="lessons.php" class="sidebar__link<?= sidebarActive('lessons.php', $current_page) ?><?= ($current_page === 'lesson.php' || $current_page === 'lesson-detail.php') ? ' sidebar__link--active' : '' ?>"> Bài học</a></li>
        <li><a href="courses.php" class="sidebar__link<?= (in_array($current_page, ['courses.php','course.php','orders.php'])) ? ' sidebar__link--active' : '' ?>"> Khóa học</a></li>
        <li><a href="flashcard.php" class="sidebar__link<?= sidebarActive('flashcard.php', $current_page) ?>"> Flashcard</a></li>
        <li><a href="practice.php" class="sidebar__link<?= sidebarActive('practice.php', $current_page) ?>"> Luyện tập</a></li>
        <li><a href="dictionary.php" class="sidebar__link<?= sidebarActive('dictionary.php', $current_page) ?>"> Từ điển</a></li>
        <li><a href="notebook.php" class="sidebar__link<?= sidebarActive('notebook.php', $current_page) ?>"> Sổ tay</a></li>
        <li><a href="community.php" class="sidebar__link<?= sidebarActive('community.php', $current_page) ?>"> Cộng đồng</a></li>
        <li><a href="pvp.php" class="sidebar__link<?= sidebarActive('pvp.php', $current_page) ?>"> PvP</a></li>
        <li><a href="leaderboard.php" class="sidebar__link<?= sidebarActive('leaderboard.php', $current_page) ?>"> BXH</a></li>
        <li><a href="radicals.php" class="sidebar__link<?= sidebarActive('radicals.php', $current_page) ?>"> Bộ thủ</a></li>
        <li><a href="ai_image.php" class="sidebar__link<?= sidebarActive('ai_image.php', $current_page) ?>"> Nhận diện AI</a></li>
        <li><a href="live_chat.php" class="sidebar__link<?= sidebarActive('live_chat.php', $current_page) ?>"> Luyện nói</a></li>
    </ul>
</nav>
...
<div class="header-auth" id="headerAuth">
    ...
    <div class="header-auth__guest" id="headerAuthGuest">
        <a href="login.php" class="btn btn--outline" style="padding:7px 14px;font-size:.82rem;font-weight:600">Đăng nhập</a>
        <a href="register.php" class="btn btn--primary" style="padding:7px 14px;font-size:.82rem;font-weight:600">Đăng ký</a>
    </div>
    <div class="header-auth__user" id="headerAuthUser" style="display:none">
        ...
        <div class="header-auth__dropdown">
            ...
            <a href="admin.php" id="headerAuthAdmin" class="header-auth__dropdown-item" style="display:none">Quản trị</a>
            <a href="admin_commerce.php" id="headerAuthCommerce" class="header-auth__dropdown-item" style="display:none">Đơn hàng & khóa học</a>
            <div class="header-auth__dropdown-divider"></div>
            <button id="headerAuthLogout" class="header-auth__dropdown-item" style="color:var(--coral);background:none;border:none;cursor:pointer;font-family:inherit;font-size:.9rem;width:100%;text-align:left;padding:10px 16px">Đăng xuất</button>
        </div>
    </div>
</div>
