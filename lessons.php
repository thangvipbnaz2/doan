...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] .lessons-page { background: linear-gradient(180deg, #0f172a, #1e293b); }
        ...
        [data-theme="dark"] .level-tab { background: #1e293b; border-color: rgba(255,255,255,.08); color: #94a3b8; }
        [data-theme="dark"] .level-tab:hover { border-color: var(--teal); color: var(--teal); }
        [data-theme="dark"] .lesson-card { background: #1e293b; }
        [data-theme="dark"] .lesson-card__title { color: #f1f5f9; }
        [data-theme="dark"] .lesson-card__desc { color: #94a3b8; }
        [data-theme="dark"] .lesson-card__meta { color: #64748b; }
        [data-theme="dark"] .lesson-card__badge--lock { background: rgba(255,255,255,.08); color: #64748b; }
        [data-theme="dark"] .progress-bar { background: rgba(255,255,255,.08); }
    </style>
</head>
<body>
