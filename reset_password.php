...
<body>
    ...
    <main class="auth-page">
        <div class="auth-card">
            ...
            <form id="reset-form">
                <div class="fg">
                    <label for="password"><i class="bi bi-key"></i> Mật khẩu mới</label>
                    <div class="password-wrapper">
                        <input type="password" id="password" placeholder="Tối thiểu 6 ký tự" required minlength="6">
                        <button type="button" class="password-toggle" onclick="togglePassword('password', this)">Hiện</button>
                    </div>
                </div>
                <div class="fg">
                    <label for="password-confirm"><i class="bi bi-check-circle"></i> Xác nhận mật khẩu</label>
                    <div class="password-wrapper">
                        <input type="password" id="password-confirm" placeholder="Nhập lại mật khẩu" required minlength="6">
                        <button type="button" class="password-toggle" onclick="togglePassword('password-confirm', this)">Hiện</button>
                    </div>
                </div>
